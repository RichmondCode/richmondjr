...
**arnoldnek!** is my official portfolio website. I hope to achieve more with the display of my skills.
...
- **This repository includes html, css and JavaScript files used to make this portfolio activity**
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/arnoldnekemiah/arnoldnek
  ```
...
If you like this project let me know sharing my portfolio with recruiters!
